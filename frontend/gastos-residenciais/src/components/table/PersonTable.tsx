...
// Tipagem de Props para o componente de tabela
...
// Componente PersonTable, para listagem de pessoas
  ...
  return (
    <div className="relative overflow-x-auto  rounded-xl ">
      <table className="w-full text-sm text-left rtl:text-right text-body">
        ...
        <tbody>
          {/* Percorre o summary caso ele exista. */}
          {summary?.data && summary?.data.length > 0 ? (
            summary.data.map((personSummary) => (
              ...
              >
                ...
                {/*Os valores é passado pela função formatCurrency para formatar*/}
                <td className="p-4">
                ...
                {/* Botões de Ação para cada linha da coluna */}
                <td className="p-4">
        ...
        {/*Footer: Usado para demostrar os totais de cada coluna */}
        <tfoot className="bg-[var(--color-primary)] text-white font-semibold">
          <tr className="divide-x divide-gray-900 ">
            ...
            <td colSpan={2} className="px-6 text-center py-4">{summary?.summaryTotal.totalPeople} pessoa(s)</td>
